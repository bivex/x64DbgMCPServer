...
public static partial class Gui {
    public static class Disassembly {
        ...
        [DllImport ( dll, CallingConvention = cdecl, EntryPoint = Script_Gui_Disassembly_SelectionGetStartEP,
                     ExactSpelling = true )]
        ...
        [DllImport ( dll, CallingConvention = cdecl, EntryPoint = Script_Gui_Disassembly_SelectionGetEndEP,
                     ExactSpelling = true )]
